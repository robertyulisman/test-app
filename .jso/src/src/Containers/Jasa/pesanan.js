  ...
  var Pesanan = function Pesanan(props) {
    ...
    var servicesOrders = function servicesOrders() {
      ...
      (0, _$$_REQUIRE(_dependencyMap[12]).getServicesOrders)(params).then(function (response) {
        if (state.page === 1) {
          setState(function (state) {
            return Object.assign(Object.assign({}, state), {}, {
              loading: false,
          ...
          setState(function (state) {
            return Object.assign(Object.assign({}, state), {}, {
              loading: false,
              arrayData: [].concat((0, _toConsumableArray2.default)(state.arrayData), (0, _toConsumableArray2.default)(response.data.service_orders))
            });
          });
        }
      }).catch(function (error) {
    ...
    var changeWidthIcon = function changeWidthIcon(name) {
      if (name === 'Service AC') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(61);
      } else if (name === 'Laundry') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(42);
      } else if (name === 'Bersih-Bersih') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(52);
      } else {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(75);
      }
    };
    var changeHeightIcon = function changeHeightIcon(name) {
      if (name === 'd45f7f57-c89c-4793-8a6c-a0b8b2b5de27') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(40);
      } else if (name === 'Laundry') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(52.5);
      } else if (name === 'Bersih-Bersih') {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(52);
      } else {
        return (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(50);
    ...
    var renderItem = function renderItem(_ref) {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
        ...
        source: {
          uri: item.service_category && item.service_category.image_url
        }
      ...
      }, item.service_category && item.service_category.name), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      }, (0, _moment.default)(item.time).add(-7, 'hours').format('LLL'))), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    var renderItemShimmer = function renderItemShimmer(_ref2) {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        ...
        style: [styles.viewStatus, {
          width: (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(85)
        }]
      })))));
    };
  ...
  var styles = _reactNative.StyleSheet.create({
    ...
    viewRow: {
      ...
      paddingTop: (0, _$$_REQUIRE(_dependencyMap[13]).toDp)(16)
    },
    viewImage: {
