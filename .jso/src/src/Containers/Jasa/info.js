  ...
  var InfoJasaScreen = function InfoJasaScreen(props) {
    ...
    var renderContent = function renderContent() {
      return /*#__PURE__*/_react.default.createElement(_reactNative.ScrollView, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        ...
        textType: "semibold",
        style: styles.textBank
      }, "PT Mahkota Permata Jaya"))), /*#__PURE__*/_react.default.createElement(_CustomText.default, {
      ...
      }, props.route.params.bank.virtual_account_number), /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
        style: styles.touchSalin,
        onPress: function onPress() {
          _clipboard.default.setString(props.route.params.bank.virtual_account_number);
      ...
      return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        ...
        onPress: function onPress() {
          if (state.imageUrl !== '') {
            ...
            (0, _$$_REQUIRE(_dependencyMap[14]).postServicePaymentProcess)(props.route.params.id, data).then(function (response) {
              setState(function (state) {
                return Object.assign(Object.assign({}, state), {}, {
                  loading: false,
                  modalSuccess: true
  ...
  var _default = exports.default = InfoJasaScreen;
