  ...
  var styles = _reactNative.StyleSheet.create({
    ...
    modalFooter: {
      ...
      backgroundColor: 'white',
      borderTopWidth: _reactNative.Platform.OS === 'ios' ? (0, _$$_REQUIRE(_dependencyMap[1]).toDp)(1) : 0,
      ...
      paddingBottom: _reactNative.Platform.OS === 'android' ? (0, _$$_REQUIRE(_dependencyMap[1]).toDp)(10) : (0, _$$_REQUIRE(_dependencyMap[2]).getBottomSpace)()
    },
    imgUser: {
      width: (0, _$$_REQUIRE(_dependencyMap[1]).toDp)(40),
      height: (0, _$$_REQUIRE(_dependencyMap[1]).toDp)(40),
    ...
    touchKirim: {
      marginTop: (0, _$$_REQUIRE(_dependencyMap[1]).toDp)(48),
