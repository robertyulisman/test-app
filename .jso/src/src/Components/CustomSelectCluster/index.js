  ...
  var CustomSelectCluster = /*#__PURE__*/function (_Component) {
    function CustomSelectCluster(props) {
      var _this;
      (0, _classCallCheck2.default)(this, CustomSelectCluster);
      _this = _callSuper(this, CustomSelectCluster, [props]);
      ...
      _this.renderModal = function () {
        return /*#__PURE__*/_react.default.createElement(_reactNativeModal.default, {
          ...
          return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
            style: [styles.viewTextModal, {
              borderBottomColor: _this.props.darkMode ? '#1C1C1E' : '#e9ebed'
            }],
            key: index,
            onPress: function onPress() {
              _this.setState({
                statusAll: !_this.state.statusAll,
                arrayData: _this.state.arrayData.map(function (data, i) {
                  if (index == 0) {
                    return Object.assign(Object.assign({}, data), {}, {
                      status: !_this.state.statusAll
                    });
                  }
                  return Object.assign(Object.assign({}, data), {}, {
            ...
            source: item.status ? _$$_REQUIRE(_dependencyMap[10]).allLogo.icNewsCheck : _$$_REQUIRE(_dependencyMap[10]).allLogo.icCheckboxUnChecked,
        ...
        _react.default.createElement(_reactNative.View, {
          ...
          style: styles.viewCenterButton
        }, /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
          style: styles.touchKirim,
          onPress: function onPress() {
            var selected = [];
            _this.state.arrayData.map(function (data, index) {
              if (data.status) {
                //selected.push({name: data.name})
                selected.push(data.id);
              }
            });
            if (_this.state.arrayData.length !== 0) {
              if (_this.state.arrayData[0].status) {
                selected.shift();
              }
            }
    ...
    (0, _inherits2.default)(CustomSelectCluster, _Component);
    return (0, _createClass2.default)(CustomSelectCluster, [{
      key: "render",
      value: function render() {
        ...
        }, this.renderModal(), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
          style: styles.textTitle
        }, title), desc !== '' && /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
  ...
  var styles = _reactNative.StyleSheet.create({
    ...
    touchKirim: {
      ...
      justifyContent: 'center',
      alignItems: 'center',
      marginBottom: (0, _$$_REQUIRE(_dependencyMap[11]).toDp)(24)
    },
    textKirim: {
      fontSize: (0, _$$_REQUIRE(_dependencyMap[11]).toDp)(14),
  ...
  var _default = exports.default = CustomSelectCluster;
