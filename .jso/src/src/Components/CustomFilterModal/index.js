  ...
  var CustomFilterModal = /*#__PURE__*/function (_Component) {
    function CustomFilterModal(props) {
      var _this;
      (0, _classCallCheck2.default)(this, CustomFilterModal);
      _this = _callSuper(this, CustomFilterModal, [props]);
    ...
    (0, _inherits2.default)(CustomFilterModal, _Component);
    return (0, _createClass2.default)(CustomFilterModal, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/_react.default.createElement(_reactNative.KeyboardAvoidingView, {
          style: Object.assign(Object.assign({}, styles.viewForm), style)
          ...
          source: _$$_REQUIRE(_dependencyMap[10]).allLogo.icFilter,
  ...
  var styles = _reactNative.StyleSheet.create({
    ...
    viewSearch: {
      ...
      height: _reactNative.Platform.OS === 'ios' ? (0, _$$_REQUIRE(_dependencyMap[11]).toDp)(40) : (0, _$$_REQUIRE(_dependencyMap[11]).toDp)(50),
      alignItems: 'center',
      flexDirection: 'row',
      borderRadius: (0, _$$_REQUIRE(_dependencyMap[11]).toDp)(10)
    },
  ...
  var _default = exports.default = CustomFilterModal;
