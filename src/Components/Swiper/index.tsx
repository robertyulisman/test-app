...
export default class extends Component<PropsComponent, any> {
  private initialRender = true;

  private autoplayTimer: any = null;
  private loopJumpTimer: any = null;
  private scrollView: any;
  private internals: any;

  static defaultProps: Partial<PropsComponent> = {
    horizontal: true,
    pagingEnabled: true,
  ...
  public constructor(props: PropsComponent) {
    super(props);
  ...
  initState(props: any, updateIndex = false) {
    ...
    initState.children = Array.isArray(props.children)
      ? props.children.filter((child: any) => child)
      : props.children;
   ...
   */
  updateIndex = (offset: any, dir: any, cb: any) => {
  ...
  scrollBy = (index: any, animated: boolean = true) => {
  ...
  scrollTo = (index: any, animated = true) => {
      ...
      pages = pages.map((page: any, i: number) => {
        if (loadMinimal) {
          if (
            ...
            return (
              <View style={pageStyleLoading as any} key={i}>
