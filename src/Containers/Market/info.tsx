...
import { postProductPaymentProcess, postUpload } from '../../Services/Apis';

const { width, height } = Dimensions.get('window');
const InfoMarketScreen = (props: any) => {
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            if (state.imageUrl !== '') {
              ...
              postProductPaymentProcess(props.route.params.id, data)
                .then((response) => {
...
export default InfoMarketScreen;
